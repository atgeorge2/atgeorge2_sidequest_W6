...
export class Game {
  ...
  _wireEventListeners() {
    ...
    if (this.sound) {
      this._unsubs.push(
        this.events.on("leaf:collected", () => this.sound.play("reward")),
      );
      this._unsubs.push(
        this.events.on("player:damaged", () => this.sound.play("hurt")),
      );
      this._unsubs.push(
        this.events.on("player:died", () => this.sound.play("death_sound")),
      );
      this._unsubs.push(
      ...
      this._unsubs.push(
        this.events.on("level:won", () => this.sound.play("reward")),
      );
      this._unsubs.push(
